...
public class MainProgram extends JFrame {
	...
	private JPanel contentPane;
	 ...
	 MainData md = new MainData(); // 테스트용으로 추가한 값 : 생략가능 (데이터 저장 및 불러오기 미구현)
	/**
	...
	public MainProgram() {
		...
		btn_menu1.setFont(new Font("맑은 고딕", Font.BOLD, 12));
		...
		btn_menu2.setFont(new Font("맑은 고딕", Font.BOLD, 12));
		...
		btn_menu3.setFont(new Font("맑은 고딕", Font.BOLD, 12));
		...
		btn_menu4.setFont(new Font("맑은 고딕", Font.BOLD, 12));
